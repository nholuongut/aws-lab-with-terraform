...
resource "aws_s3_bucket" "nholuong_lamda_source" {
  bucket = "nholuong-lamda-source"
...
resource "aws_s3_object" "lambda_hello_world" {
  bucket = aws_s3_bucket.nholuong_lamda_source.id
...
resource "aws_lambda_function" "hello_world" {
  ...
  s3_bucket = aws_s3_bucket.nholuong_lamda_source.id
